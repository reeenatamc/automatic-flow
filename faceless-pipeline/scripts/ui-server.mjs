...
const COMMANDS = {
  ...
  prepare: "node scripts/enhance-images.mjs && node scripts/master-audio.mjs && node scripts/transcribe-cloud.mjs && node scripts/captions-from-script.mjs && node scripts/build-manifest.mjs",
  build: "node scripts/check.mjs && node scripts/enhance-images.mjs && node scripts/master-audio.mjs && node scripts/transcribe-cloud.mjs && node scripts/captions-from-script.mjs && node scripts/build-manifest.mjs",
